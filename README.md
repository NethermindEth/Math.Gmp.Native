...
Copyright 2017 Robert Baron, Machine Cognitis

This file is a derivative work of the GNU MP Library.

The GMP Native Interface for .NET is free software; you can redistribute it and/or modify it under
the terms of either:
...
The GMP Native Interface for .NET Library is distributed in the hope that it will be useful, but
...
License along with the GNU MP Library.  If not, see https://www.gnu.org/licenses/.
